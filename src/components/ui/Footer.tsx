        ...
        <div className={`${toBottom && "absolute bottom-0 left-0 right-0"}`}>
            <div>
                <div className="relative bg-black">
                    <div className="w-full flex gap-[205px] justify-center mr-[165px]">
                        ...
                        <div className="flex gap-[100px] items-start pt-[80px]">
                            ...
                            <div className="flex flex-col gap-[15px] items-end">
                                <span
                                    className="font-medium text-[16px] leading-6 tracking-[0.1px] text-white opacity-60">Predajné miesto</span>
                                <span
                                    className="font-medium text-[16px] leading-6 tracking-[0.1px] text-white opacity-60">Rožňavská 1A</span>
                                <span
                                    className="font-medium text-[16px] leading-6 tracking-[0.1px] text-white opacity-60">831 04 Bratislava</span>
                                <span
                                    className="font-medium text-[16px] leading-6 tracking-[0.1px] text-white opacity-60">+421 911 000 000</span>
                                <span
                                    className="font-medium text-[16px] leading-6 tracking-[0.1px] text-white opacity-60">info@oliviaresidence.sk</span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex gap-[650px] bg-[#000000] justify-center opacity-90">
                    <p className="pl-[165px] text-[14px] leading-5 text-[#999999] py-[20px]">© 2022 Olivia Residence.
