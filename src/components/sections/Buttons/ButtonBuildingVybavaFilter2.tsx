...
const ButtonBuildingVybavaFilter2:FunctionComponent<ButtonsVybavaProps> = ({text}) => {
            ...
            <button onClick={changeColor}
                ...
                <div className="flex gap-[15px] items-center">
                    <div className="hidden xl:block">
                        <BasketIcon width="20" height="20" fill={`${isClicked ? "#0E3F3B" : "white"}`}/>
                    </div>
                    <span
...
export default ButtonBuildingVybavaFilter2;