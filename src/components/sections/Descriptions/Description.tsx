...
const Description: FunctionComponent<DescriptionProps> = ({
    ...
    return (
        <div className={`flex flex-col xl:flex-row gap-[45px] xl:gap-[110px] ${reverseFlex && "xl:flex-row-reverse"} mx-4 xl:mx-[165px] items-center justify-center mb-[120px] xl:mb-[165px]`}>
