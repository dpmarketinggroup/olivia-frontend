...
const SwiperPastProjects = () => {
    return (
        <div className="text-white py-[45px] xl:py-[110px] px-[1rem] xl:px-0">
            <div className="flex gap-[400px] w-ful xl:max-w-[1310px] xl:ml-[165px] items-end xl:justify-between mb-[35px] xl:mb-[40px] mx-[165px]">
            ...
            <div className="flex gap-[555px] ml-[165px] mb-[40px]">
                <p className="text-[#676766] w-[530px] text-[18px] leading-7 ">Sme skúsení tím ľudí s dlhoročnými
