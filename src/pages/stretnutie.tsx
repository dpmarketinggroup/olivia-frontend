    ...
    return (
        <>
            <div className="flex justify-center">
                <div>
                    <div className="bg-[#0E3F3B] w-[1440px]">
                        <div className="flex flex-col items-center pt-[80px]">
                            <MapPoint2Icon/>
                            <h1 className="font-bold text-[40px] leading-[48px] tracking-[-0.5px] text-white w-[600px] text-center mb-[120px] mt-[40px]">Nezáväzné stretnutie v Predajnom mieste</h1>
                        </div>
                                ...
                                <div className="mt-[70px]">
                                    ...
                                    <div className="mb-[20px]">
                                        <div className="flex gap-[20px] items-center">
                                            <PhoneIcon/>
                                            <span className="font-bold text-[18px] leading-7 text-white">+421 911 000 000</span>
                                        </div>
                                        <div className="flex gap-[20px] items-center">
                                            <EmailSignIcon/>
                                            <span
