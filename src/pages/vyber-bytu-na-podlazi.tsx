        ...
        <>
            <div className="flex justify-center my-[70px]">
                <div className="mx-[165px]">
                    <div className="flex flex-col gap-[30px] items-center mb-[50px]">
                        <FloorPlanIcon/>
                        <h1 className="font-bold text-[40px] leading-[48px] tracking-[-0.5px]">Výber apartmánu na
                            podlaží</h1>
                    </div>
                    <div className="flex justify-between">
                        <div
                            className="flex gap-[13px] items-center px-[29px] py-[16px] bg-[#F5F5F5] rounded-[33px] mr-[155px]">
                            <span className="font-bold text-[18px] leading-[28px] text-[#476761]">7. podlažie</span>
                            <ArrowDownNotFilled/>
                        </div>
                        <div
                            className="flex gap-[25px] items-center py-[20px] px-[25px] bg-[#F5F5F5] rounded-[33px] mr-[285px]">
                            <span className="font-medium text-[14px] leading-5 text-[#00000033]">Výber podlažia</span>
                            <RightArrowIcon stroke="#00000033"/>
                            <span className="font-medium text-[14px] leading-5 text-[#476761]">Výber apartmánu</span>
            ...
            <div className="flex gap-[32px] ml-[165px]">
                <div className="bg-[#F5F5F5] max-h-[500px]">
                    ...
                    <Link href="/">
                        <button className="font-medium text-[16px] leading-6 tracking-[0.1px] text-white px-[20px] py-[6px] bg-[#476761]">
                            Detail bytu
                        </button>
                    </Link>
                    </div>
