        ...
        <>
            ...
            <nav
                ...
                <div
                    ...
                    <div
                        className={`${isOpenMobileNav && 'h-screen'} xl:h-auto flex flex-col xl:flex-row gap-[50] items-center xl:ml-[40px] xl:mr-0 min-w-full xl:min-w-fit`}>
                        <div
                        ...
                        <div onClick={() => {
                            ...
                            <div
                                ...
                                <div className={'xl:hidden flex flex-col gap-[20px]'}>
                                    ...
                                    <Link href={'/ponuka-bytov#garazove-parkovanie'} className={'xl:hidden'}>
                            ...
                            <Link href={'/stretnutie'}>
                                <button
                                    className={'bg-[#476761] xl:hidden px-[10px] py-[6px] w-full text-white'}>Nezáväzné
                                    stretnutie
                                </button>
                            </Link>
                        </div>
                    ...
                    <div className="flex gap-[27px] mr-[40px]">
                        ...
                        <Link href='/stretnutie'>
                            <button
                                ...
                                onClick={() => setIsOpenMobileNav(false)}>Nezáväzné
                                stretnutie
                            </button>
                        </Link>
                    </div>
