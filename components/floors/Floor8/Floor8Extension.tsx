...
const Floor8Extension = () => {
  const fetch = useStore((state) => state.setSelectedApartment);
  const router = useRouter();
  const [thirteen] = useAvailability("09.13");
  const [twelve] = useAvailability("09.12");
  const [eleven] = useAvailability("09.11");
  const [ten] = useAvailability("09.10");
  const [nine] = useAvailability("09.09");
  const [eight] = useAvailability("09.08");
  const [seven] = useAvailability("09.07");
  const [six] = useAvailability("09.06");
  const [five] = useAvailability("09.05");
  const [four] = useAvailability("09.04");
  const [three] = useAvailability("09.03");
  const [two] = useAvailability("09.02");
  const [one] = useAvailability("09.01");
  const [K_eight] = useAvailability("K908");
  const [K_seven] = useAvailability("K907");
  const [K_six] = useAvailability("K906");
  const [K_five] = useAvailability("K905");
  const [K_four] = useAvailability("K904");
  const [K_three] = useAvailability("K903");
  const [K_two] = useAvailability("K902");
  const [K_one] = useAvailability("K901");
  return (
    <>
      <g id="_x30_9.13">
        <g
          ...
          onClick={() => fetch("09.13", Number(router.query.id))}
        >
      ...
      <g id="_x30_9.12">
        <g
          ...
          onClick={() => fetch("09.12", Number(router.query.id))}
        >
      ...
      <g id="_x30_9.11">
        <g
          ...
          onClick={() => fetch("09.11", Number(router.query.id))}
        >
      ...
      <g id="_x30_9.10">
        <g
          ...
          onClick={() => fetch("09.10", Number(router.query.id))}
        >
      ...
      <g id="_x30_9.09">
        <g
          ...
          onClick={() => fetch("09.09", Number(router.query.id))}
        >
      ...
      <g id="_x30_9.08">
        <g
          ...
          onClick={() => fetch("09.08", Number(router.query.id))}
        >
      ...
      <g id="_x30_9.07">
        <g
          ...
          onClick={() => fetch("09.07", Number(router.query.id))}
        >
      ...
      <g id="_x30_9.06">
        <g
          ...
          onClick={() => fetch("09.06", Number(router.query.id))}
        >
      ...
      <g id="_x30_9.05_1_">
        <g
          ...
          onClick={() => fetch("09.05", Number(router.query.id))}
        >
      ...
      <g id="_x30_9.04_1_">
        <g
          ...
          onClick={() => fetch("09.04", Number(router.query.id))}
        >
      ...
      <g id="_x30_9.03">
        <g
          ...
          onClick={() => fetch("09.03", Number(router.query.id))}
        >
      ...
      <g id="_x30_9.02">
        <g
          ...
          onClick={() => fetch("09.02", Number(router.query.id))}
        >
      ...
      <g id="_x30_9.01">
        <g
          ...
          onClick={() => fetch("09.01", Number(router.query.id))}
        >
      ...
      <g id="_x30_K901">
        <g
          ...
          onClick={() => fetch("K901", Number(router.query.id))}
        >
      ...
      <g id="_x30_K902">
        <g
          ...
          onClick={() => fetch("K902", Number(router.query.id))}
        >
      ...
      <g id="_x30_K903">
        <g
          ...
          onClick={() => fetch("K903", Number(router.query.id))}
        >
      ...
      <g id="_x30_K904">
        <g
          ...
          onClick={() => fetch("K904", Number(router.query.id))}
        >
      ...
      <g id="_x30_K905">
        <g
          ...
          onClick={() => fetch("K905", Number(router.query.id))}
        >
...
export default Floor8Extension;
