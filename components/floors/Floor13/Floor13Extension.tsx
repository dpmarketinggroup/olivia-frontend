...
const Floor13Extension = () => {
    ...
    return (
        <>
            <g id="_x31_4.12_1_">
                <polygon className={`st20 ${displayClassname(twelve)}`} onClick={() => fetch('14.12', Number(router.query.id))}
            ...
            <g id="_x31_4.11">
                <polygon className={`st20 ${displayClassname(eleven)}`} onClick={() => fetch('14.11', Number(router.query.id))}
            ...
            <g id="_x31_4.10">
                <polygon className={`st20 ${displayClassname(ten)}`} onClick={() => fetch('14.10', Number(router.query.id))}
            ...
            <g id="_x31_4.09">
                <polygon className={`st20 ${displayClassname(nine)}`} onClick={() => fetch('14.09', Number(router.query.id))}
                         points="786.9,293 630.7,293 630.7,330.8 624.5,330.8 624.5,438.6 759.2,438.6 759.2,423.3 786.9,423.3  "/>
            </g>
            <g id="_x31_4.08">
                <polygon className={`st20 ${displayClassname(eight)}`} onClick={() => fetch('14.08', Number(router.query.id))}
            ...
            <g id="_x31_4.07">
                <polygon className={`st20 ${displayClassname(seven)}`} onClick={() => fetch('14.07', Number(router.query.id))}
                         points="554.3,250 491.6,250 491.6,206 426.4,206 426.4,438.6 491.6,438.6 491.6,298.9 554.3,298.9  "/>
            </g>
            <g id="_x31_4.06">
                <polygon className={`st20 ${displayClassname(six)}`} onClick={() => fetch('14.06', Number(router.query.id))}
            ...
            <g id="_x31_4.05">
                <polygon className={`st20 ${displayClassname(five)}`} onClick={() => fetch('14.05', Number(router.query.id))}
            ...
            <g id="_x31_4.04">
                <polygon className={`st20 ${displayClassname(four)}`} onClick={() => fetch('14.04', Number(router.query.id))}
            ...
            <g id="_x31_4.03">
                <polygon className={`st20 ${displayClassname(three)}`} onClick={() => fetch('14.03', Number(router.query.id))}
            ...
            <g id="_x31_4.02">
                <polygon className={`st20 ${displayClassname(two)}`} onClick={() => fetch('14.02', Number(router.query.id))}
            ...
            <g id="_x31_4.01">
                <polygon className={`st20 ${displayClassname(one)}`} onClick={() => fetch('14.01', Number(router.query.id))}
