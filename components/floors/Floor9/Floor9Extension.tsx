...
const Floor9Extension = () => {
    ...
    return (
        <>
            <g id="_x31_0.12">
                <g id="_x31_4.12_1_">
                    <polygon className={`st19 ${displayClassname(twelve)}`} onClick={() => fetch('10.12', Number(router.query.id))}
            ...
            <g id="_x31_0.11">
                <g id="_x31_4.11">
                    <polygon className={`st19 ${displayClassname(eleven)}`} onClick={() => fetch('10.11', Number(router.query.id))}
            ...
            <g id="_x31_0.10">
                <g id="_x31_4.10">
                    <polygon className={`st19 ${displayClassname(ten)}`} onClick={() => fetch('10.10', Number(router.query.id))}
            ...
            <g id="_x31_0.09">
                <g id="_x31_4.09">
                    <polygon className={`st19 ${displayClassname(nine)}`} onClick={() => fetch('10.09', Number(router.query.id))}
                             points="786.9,293 630.7,293 630.7,330.8 624.5,330.8 624.5,438.6 759.2,438.6 759.2,423.3 786.9,423.3       "/>
                </g>
            </g>
            <g id="_x31_0.08">
                <g id="_x31_4.08">
                    <polygon className={`st19 ${displayClassname(eight)}`} onClick={() => fetch('10.08', Number(router.query.id))}
            ...
            <g id="_x31_0.07">
                <g id="_x31_4.07">
                    <polygon className={`st19 ${displayClassname(seven)}`} onClick={() => fetch('10.07', Number(router.query.id))}
                             points="554.3,250 491.6,250 491.6,206 426.4,206 426.4,438.6 491.6,438.6 491.6,298.9 554.3,298.9   "/>
                </g>
            </g>
            <g id="_x31_0.06">
                <g id="_x31_4.06">
                    <polygon className={`st19 ${displayClassname(six)}`} onClick={() => fetch('10.06', Number(router.query.id))}
            ...
            <g id="_x31_0.05">
                <g id="_x31_4.05">
                    <polygon className={`st19 ${displayClassname(five)}`} onClick={() => fetch('10.05', Number(router.query.id))}
            ...
            <g id="_x31_0.04">
                <g id="_x31_4.04">
                    <polygon className={`st19 ${displayClassname(four)}`} onClick={() => fetch('10.04', Number(router.query.id))}
            ...
            <g id="_x31_0.03">
                <g id="_x31_4.03">
                    <polygon className={`st19 ${displayClassname(three)}`} onClick={() => fetch('10.03', Number(router.query.id))}
            ...
            <g id="_x31_0.02">
                <g id="_x31_4.02">
                    <polygon className={`st19 ${displayClassname(two)}`} onClick={() => fetch('10.02', Number(router.query.id))}
            ...
            <g id="_x31_0.01">
                <g id="_x31_4.01">
                    <polygon className={`st19 ${displayClassname(one)}`} onClick={() => fetch('10.01', Number(router.query.id))}
