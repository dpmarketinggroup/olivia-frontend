...
const Floor9Extension = () => {
  const fetch = useStore((state) => state.setSelectedApartment);
  const router = useRouter();
  const [thirteen] = useAvailability("10.13");
  const [twelve] = useAvailability("10.12");
  const [eleven] = useAvailability("10.11");
  const [ten] = useAvailability("10.10");
  const [nine] = useAvailability("10.09");
  const [eight] = useAvailability("10.08");
  const [seven] = useAvailability("10.07");
  const [six] = useAvailability("10.06");
  const [five] = useAvailability("10.05");
  const [four] = useAvailability("10.04");
  const [three] = useAvailability("10.03");
  const [two] = useAvailability("10.02");
  const [one] = useAvailability("10.01");
  const [K_eight] = useAvailability("K1008");
  const [K_seven] = useAvailability("K1007");
  const [K_six] = useAvailability("K1006");
  const [K_five] = useAvailability("K1005");
  const [K_four] = useAvailability("K1004");
  const [K_three] = useAvailability("K1003");
  const [K_two] = useAvailability("K1002");
  const [K_one] = useAvailability("K1001");
  return (
    <>
      <g id="_x31_0.13">
        <g
          ...
          onClick={() => fetch("10.13", Number(router.query.id))}
        >
      ...
      <g id="_x31_0.12">
        <g
          ...
          onClick={() => fetch("10.12", Number(router.query.id))}
        >
      ...
      <g id="_x31_0.11">
        <g
          ...
          onClick={() => fetch("10.11", Number(router.query.id))}
        >
      ...
      <g id="_x31_0.10">
        <g
          ...
          onClick={() => fetch("10.10", Number(router.query.id))}
        >
      ...
      <g id="_x31_0.09">
        <g
          ...
          onClick={() => fetch("10.09", Number(router.query.id))}
        >
      ...
      <g id="_x31_0.08">
        <g
          ...
          onClick={() => fetch("10.08", Number(router.query.id))}
        >
      ...
      <g id="_x31_0.07">
        <g
          ...
          onClick={() => fetch("10.07", Number(router.query.id))}
        >
      ...
      <g id="_x31_0.06">
        <g
          ...
          onClick={() => fetch("10.06", Number(router.query.id))}
        >
      ...
      <g id="_x31_0.05">
        <g
          ...
          onClick={() => fetch("10.05", Number(router.query.id))}
        >
      ...
      <g id="_x31_0.04">
        <g
          ...
          onClick={() => fetch("10.04", Number(router.query.id))}
        >
      ...
      <g id="_x31_0.03">
        <g
          ...
          onClick={() => fetch("10.03", Number(router.query.id))}
        >
      ...
      <g id="_x31_0.02">
        <g
          ...
          onClick={() => fetch("10.02", Number(router.query.id))}
        >
      ...
      <g id="_x31_0.01">
        <g
          ...
          onClick={() => fetch("10.01", Number(router.query.id))}
        >
      ...
      <g id="_x30_K1001">
        <g
          ...
          onClick={() => fetch("K1001", Number(router.query.id))}
        >
      ...
      <g id="_x30_K1002">
        <g
          ...
          onClick={() => fetch("K1002", Number(router.query.id))}
        >
      ...
      <g id="_x30_K1003">
        <g
          ...
          onClick={() => fetch("K1003", Number(router.query.id))}
        >
      ...
      <g id="_x30_K1004">
        <g
          ...
          onClick={() => fetch("K1004", Number(router.query.id))}
        >
      ...
      <g id="_x30_K1005">
        <g
          ...
          onClick={() => fetch("K1005", Number(router.query.id))}
        >
...
export default Floor9Extension;
