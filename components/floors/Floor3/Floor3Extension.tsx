...
const Floor3Extension = () => {
    ...
    return (
        <>
            ...
            <g id="_x30_4.11">
                <g id="_x31_4.11">
                    <polygon className="st19" onClick={() => fetch('04.11', Number(router.query.id))}
            ...
            <g id="_x30_4.09">
                <g id="_x31_4.09">
                    <polygon className="st19" onClick={() => fetch('04.09', Number(router.query.id))}
                             points="786.9,293 630.7,293 630.7,330.8 624.5,330.8 624.5,438.6 759.2,438.6 759.2,423.3 786.9,423.3       "/>
                </g>
            </g>
            <g id="_x30_4.08">
                <g id="_x31_4.08">
                    <polygon className="st19" onClick={() => fetch('04.08', Number(router.query.id))}
            ...
            <g id="_x30_4.07">
                <g id="_x31_4.07">
                    <polygon className="st19" onClick={() => fetch('04.07', Number(router.query.id))}
            ...
            <g id="_x30_4.05">
                <g id="_x31_4.05">
                    <polygon className="st19" onClick={() => fetch('04.05', Number(router.query.id))}
            ...
            <g id="_x30_4.04">
                <g id="_x31_4.04">
                    <polygon className="st19" onClick={() => fetch('04.04', Number(router.query.id))}
            ...
            <g id="_x30_4.03">
                <g id="_x31_4.03">
                    <polygon className="st19" onClick={() => fetch('04.03', Number(router.query.id))}
            ...
            <g id="_x30_4.02">
                <g id="_x31_4.02">
                    <polygon className="st19" onClick={() => fetch('04.02', Number(router.query.id))}
            ...
            <g id="_x30_4.01">
                <g id="_x31_4.01">
                    <polygon className="st19" onClick={() => fetch('04.01', Number(router.query.id))}
