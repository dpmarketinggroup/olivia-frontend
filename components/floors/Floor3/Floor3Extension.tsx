...
const Floor3Extension = () => {
  ...
  const [thirteen] = useAvailability("04.13");
  const [twelve] = useAvailability("04.12");
  const [eleven] = useAvailability("04.11");
  const [ten] = useAvailability("04.10");
  const [nine] = useAvailability("04.09");
  const [eight] = useAvailability("04.08");
  const [seven] = useAvailability("04.07");
  const [six] = useAvailability("04.06");
  const [five] = useAvailability("04.05");
  const [four] = useAvailability("04.04");
  const [three] = useAvailability("04.03");
  const [two] = useAvailability("04.02");
  const [one] = useAvailability("04.01");
  const [K_eight] = useAvailability("K408");
  const [K_seven] = useAvailability("K407");
  const [K_six] = useAvailability("K406");
  const [K_five] = useAvailability("K405");
  const [K_four] = useAvailability("K404");
  const [K_three] = useAvailability("K403");
  const [K_two] = useAvailability("K402");
  const [K_one] = useAvailability("K401");
    ...
    <>
      <g id="_x30_4.13">
        <g
          ...
          onClick={() => fetch("04.13", Number(router.query.id))}
        >
      ...
      <g id="_x30_4.12">
        <g
          ...
          onClick={() => fetch("04.12", Number(router.query.id))}
        >
      ...
      <g id="_x30_4.11">
        <g
          ...
          onClick={() => fetch("04.11", Number(router.query.id))}
        >
      ...
      <g id="_x30_4.10">
        <g
          ...
          onClick={() => fetch("04.10", Number(router.query.id))}
        >
      ...
      <g id="_x30_4.09">
        <g
          ...
          onClick={() => fetch("04.09", Number(router.query.id))}
        >
      ...
      <g id="_x30_4.08">
        <g
          ...
          onClick={() => fetch("04.08", Number(router.query.id))}
        >
      ...
      <g id="_x30_4.07">
        <g
          ...
          onClick={() => fetch("04.07", Number(router.query.id))}
        >
      ...
      <g id="_x30_4.06">
        <g
          ...
          onClick={() => fetch("04.06", Number(router.query.id))}
        >
      ...
      <g id="_x30_4.05">
        <g
          ...
          onClick={() => fetch("04.05", Number(router.query.id))}
        >
      ...
      <g id="_x30_4.04">
        <g
          ...
          onClick={() => fetch("04.04", Number(router.query.id))}
        >
      ...
      <g id="_x30_4.03">
        <g
          ...
          onClick={() => fetch("04.03", Number(router.query.id))}
        >
      ...
      <g id="_x30_4.02">
        <g
          ...
          onClick={() => fetch("04.02", Number(router.query.id))}
        >
      ...
      <g id="_x30_4.01">
        <g
          ...
          onClick={() => fetch("04.01", Number(router.query.id))}
        >
      ...
      <g id="_x30_K401">
        <g
          ...
          onClick={() => fetch("K401", Number(router.query.id))}
        >
      ...
      <g id="_x30_K402">
        <g
          ...
          onClick={() => fetch("K402", Number(router.query.id))}
        >
      ...
      <g id="_x30_K403">
        <g
          ...
          onClick={() => fetch("K403", Number(router.query.id))}
        >
      ...
      <g id="_x30_K404">
        <g
          ...
          onClick={() => fetch("K404", Number(router.query.id))}
        >
      ...
      <g id="_x30_K405">
        <g
          ...
          onClick={() => fetch("K405", Number(router.query.id))}
        >
...
export default Floor3Extension;
