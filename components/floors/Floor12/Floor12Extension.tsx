    ...
    return (
        <>
            <g id="_x31_3.01_1_">
                <g id="_x31_3.01">
                    <g id="_x31_4.01">
                        <polygon className={`st19 ${displayClassname(twelve)}`} onClick={() => fetch('13.12', Number(router.query.id))}
            ...
            <g id="_x31_3.02_1_">
                <g id="_x31_3.02">
                    <g id="_x31_4.02">
                        <polygon className={`st19 ${displayClassname(eleven)}`} onClick={() => fetch('13.11', Number(router.query.id))}
            ...
            <g id="_x31_3.03_1_">
                <g id="_x31_3.03">
                    <g id="_x31_4.03">
                        <polygon className={`st19 ${displayClassname(ten)}`} onClick={() => fetch('13.10', Number(router.query.id))}
            ...
            <g id="_x31_3.04_1_">
                <g id="_x31_3.04">
                    <g id="_x31_4.04">
                        <polygon className={`st19 ${displayClassname(nine)}`} onClick={() => fetch('13.09', Number(router.query.id))}
            ...
            <g id="_x31_3.05_1_">
                <g id="_x31_3.05">
                    <g id="_x31_4.05">
                        <polygon className={`st19 ${displayClassname(eight)}`} onClick={() => fetch('13.08', Number(router.query.id))}
            ...
            <g id="_x31_3.06_1_">
                <g id="_x31_3.06">
                    <g id="_x31_4.06">
                        <polygon className={`st19 ${displayClassname(seven)}`} onClick={() => fetch('13.07', Number(router.query.id))}
            ...
            <g id="_x31_3.07_1_">
                <g id="_x31_3.07">
                    <g id="_x31_4.07">
                        <polygon className={`st19 ${displayClassname(six)}`} onClick={() => fetch('13.06', Number(router.query.id))}
            ...
            <g id="_x31_3.08_1_">
                <g id="_x31_3.08">
                    <g id="_x31_4.08">
                        <polygon className={`st19 ${displayClassname(five)}`} onClick={() => fetch('13.05', Number(router.query.id))}
            ...
            <g id="_x31_3.09_1_">
                <g id="_x31_3.09">
                    <g id="_x31_4.09">
                        <polygon className={`st19 ${displayClassname(four)}`} onClick={() => fetch('13.04', Number(router.query.id))}
            ...
            <g id="_x31_3.10_1_">
                <g id="_x31_3.10">
                    <g id="_x31_4.10">
                        <polygon className={`st19 ${displayClassname(three)}`} onClick={() => fetch('13.03', Number(router.query.id))}
            ...
            <g id="_x31_3.11_1_">
                <g id="_x31_3.11">
                    <g id="_x31_4.11">
                        <polygon className={`st19 ${displayClassname(two)}`} onClick={() => fetch('13.02', Number(router.query.id))}
            ...
            <g id="_x31_3.12_1_">
                <g id="_x31_3.12">
                    <g id="_x31_4.12_1_">
                        <polygon className={`st19 ${displayClassname(one)}`} onClick={() => fetch('13.01', Number(router.query.id))}
