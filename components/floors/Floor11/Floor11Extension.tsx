...
const Floor11Extension = () => {
    ...
    return (
        <>
            <g id="_x31_2.12">
                <g id="_x31_4.12_1_">
                    <polygon className={`st19 ${displayClassname(twelve)}`} onClick={() => fetch('12.12', Number(router.query.id))}
            ...
            <g id="_x31_2.11">
                <g id="_x31_4.11">
                    <polygon className={`st19 ${displayClassname(eleven)}`} onClick={() => fetch('12.11', Number(router.query.id))}
            ...
            <g id="_x31_2.10">
                <g id="_x31_4.10">
                    <polygon className={`st19 ${displayClassname(ten)}`} onClick={() => fetch('12.10', Number(router.query.id))}
            ...
            <g id="_x31_2.09">
                <g id="_x31_4.09">
                    <polygon className={`st19 ${displayClassname(nine)}`} onClick={() => fetch('12.09', Number(router.query.id))}
                             points="786.9,293 630.7,293 630.7,330.8 624.5,330.8 624.5,438.6 759.2,438.6 759.2,423.3 786.9,423.3       "/>
                </g>
            </g>
            <g id="_x31_2.08">
                <g id="_x31_4.08">
                    <polygon className={`st19 ${displayClassname(eight)}`} onClick={() => fetch('12.08', Number(router.query.id))}
            ...
            <g id="_x31_2.07">
                <g id="_x31_4.07">
                    <polygon className={`st19 ${displayClassname(seven)}`} onClick={() => fetch('12.07', Number(router.query.id))}
                             points="554.3,250 491.6,250 491.6,206 426.4,206 426.4,438.6 491.6,438.6 491.6,298.9 554.3,298.9   "/>
                </g>
            </g>
            <g id="_x31_2.06">
                <g id="_x31_4.06">
                    <polygon className={`st19 ${displayClassname(six)}`} onClick={() => fetch('12.06', Number(router.query.id))}
            ...
            <g id="_x31_2.05">
                <g id="_x31_4.05">
                    <polygon className={`st19 ${displayClassname(five)}`} onClick={() => fetch('12.05', Number(router.query.id))}
            ...
            <g id="_x31_2.04">
                <g id="_x31_4.04">
                    <polygon className={`st19 ${displayClassname(four)}`} onClick={() => fetch('12.04', Number(router.query.id))}
            ...
            <g id="_x31_2.03">
                <g id="_x31_4.03">
                    <polygon className={`st19 ${displayClassname(three)}`} onClick={() => fetch('12.03', Number(router.query.id))}
            ...
            <g id="_x31_2.02">
                <g id="_x31_4.02">
                    <polygon className={`st19 ${displayClassname(two)}`} onClick={() => fetch('12.02', Number(router.query.id))}
            ...
            <g id="_x31_2.01">
                <g id="_x31_4.01">
                    <polygon className={`st19 ${displayClassname(one)}`} onClick={() => fetch('12.01', Number(router.query.id))}
