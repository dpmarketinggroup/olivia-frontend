...
const Floor11Extension = () => {
  ...
  const [thirteen] = useAvailability("12.13");
  const [twelve] = useAvailability("12.12");
  const [eleven] = useAvailability("12.11");
  const [ten] = useAvailability("12.10");
  const [nine] = useAvailability("12.09");
  const [eight] = useAvailability("12.08");
  const [seven] = useAvailability("12.07");
  const [six] = useAvailability("12.06");
  const [five] = useAvailability("12.05");
  const [four] = useAvailability("12.04");
  const [three] = useAvailability("12.03");
  const [two] = useAvailability("12.02");
  const [one] = useAvailability("12.01");
  const [K_eight] = useAvailability("K1208");
  const [K_seven] = useAvailability("K1207");
  const [K_six] = useAvailability("K1206");
  const [K_five] = useAvailability("K1205");
  const [K_four] = useAvailability("K1204");
  const [K_three] = useAvailability("K1203");
  const [K_two] = useAvailability("K1202");
  const [K_one] = useAvailability("K1201");
    ...
    <>
      <g id="_x31_2.13">
        <g
          ...
          onClick={() => fetch("12.13", Number(router.query.id))}
        >
      ...
      <g id="_x31_2.12">
        <g
          ...
          onClick={() => fetch("12.12", Number(router.query.id))}
        >
      ...
      <g id="_x31_2.11">
        <g
          ...
          onClick={() => fetch("12.11", Number(router.query.id))}
        >
      ...
      <g id="_x31_2.10">
        <g
          ...
          onClick={() => fetch("12.10", Number(router.query.id))}
        >
      ...
      <g id="_x31_2.09">
        <g
          ...
          onClick={() => fetch("12.09", Number(router.query.id))}
        >
      ...
      <g id="_x31_2.08">
        <g
          ...
          onClick={() => fetch("12.08", Number(router.query.id))}
        >
      ...
      <g id="_x31_2.07">
        <g
          ...
          onClick={() => fetch("12.07", Number(router.query.id))}
        >
      ...
      <g id="_x31_2.06">
        <g
          ...
          onClick={() => fetch("12.06", Number(router.query.id))}
        >
      ...
      <g id="_x31_2.05">
        <g
          ...
          onClick={() => fetch("12.05", Number(router.query.id))}
        >
      ...
      <g id="_x31_2.04">
        <g
          ...
          onClick={() => fetch("12.04", Number(router.query.id))}
        >
      ...
      <g id="_x31_2.03">
        <g
          ...
          onClick={() => fetch("12.03", Number(router.query.id))}
        >
      ...
      <g id="_x31_2.02">
        <g
          ...
          onClick={() => fetch("12.02", Number(router.query.id))}
        >
      ...
      <g id="_x31_2.01">
        <g
          ...
          onClick={() => fetch("12.01", Number(router.query.id))}
        >
      ...
      <g id="_x30_K1201">
        <g
          ...
          onClick={() => fetch("K1201", Number(router.query.id))}
        >
      ...
      <g id="_x30_K1202">
        <g
          ...
          onClick={() => fetch("K1202", Number(router.query.id))}
        >
      ...
      <g id="_x30_K1203">
        <g
          ...
          onClick={() => fetch("K1203", Number(router.query.id))}
        >
      ...
      <g id="_x30_K1204">
        <g
          ...
          onClick={() => fetch("K1204", Number(router.query.id))}
        >
      ...
      <g id="_x30_K1205">
        <g
          ...
          onClick={() => fetch("K1205", Number(router.query.id))}
        >
