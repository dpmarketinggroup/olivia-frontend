...
const Floor7Extension = () => {
  ...
  const [thirteen] = useAvailability("08.13");
  ...
  const [K_eight] = useAvailability("K808");
  const [K_seven] = useAvailability("K807");
  const [K_six] = useAvailability("K806");
  const [K_five] = useAvailability("K805");
  const [K_four] = useAvailability("K804");
  const [K_three] = useAvailability("K803");
  const [K_two] = useAvailability("K802");
  const [K_one] = useAvailability("K801");
  return (
    <>
      <g id="_x30_8.13">
        <g
          ...
          onClick={() => fetch("08.13", Number(router.query.id))}
        >
      ...
      <g id="_x30_8.12">
        <g
          ...
          onClick={() => fetch("08.12", Number(router.query.id))}
        >
      ...
      <g id="_x30_8.11">
        <g
          ...
          onClick={() => fetch("08.11", Number(router.query.id))}
        >
      ...
      <g id="_x30_8.10">
        <g
          ...
          onClick={() => fetch("08.10", Number(router.query.id))}
        >
      ...
      <g id="_x30_8.09">
        <g
          ...
          onClick={() => fetch("08.09", Number(router.query.id))}
        >
      ...
      <g id="_x30_8.08">
        <g
          ...
          onClick={() => fetch("08.08", Number(router.query.id))}
        >
      ...
      <g id="_x30_8.07">
        <g
          ...
          onClick={() => fetch("08.07", Number(router.query.id))}
        >
      ...
      <g id="_x30_8.06">
        <g
          ...
          onClick={() => fetch("08.06", Number(router.query.id))}
        >
      ...
      <g id="_x30_8.05">
        <g
          ...
          onClick={() => fetch("08.05", Number(router.query.id))}
        >
      ...
      <g id="_x30_8.04">
        <g
          ...
          onClick={() => fetch("08.04", Number(router.query.id))}
        >
      ...
      <g id="_x30_8.03">
        <g
          ...
          onClick={() => fetch("08.03", Number(router.query.id))}
        >
      ...
      <g id="_x30_8.02">
        <g
          ...
          onClick={() => fetch("08.02", Number(router.query.id))}
        >
      ...
      <g id="_x30_K801">
        <g
          ...
          onClick={() => fetch("K801", Number(router.query.id))}
        >
      ...
      <g id="_x30_K802">
        <g
          ...
          onClick={() => fetch("K802", Number(router.query.id))}
        >
      ...
      <g id="_x30_K803">
        <g
          ...
          onClick={() => fetch("K803", Number(router.query.id))}
        >
      ...
      <g id="_x30_K804">
        <g
          ...
          onClick={() => fetch("K804", Number(router.query.id))}
        >
      ...
      <g id="_x30_K805">
        <g
          ...
          onClick={() => fetch("K805", Number(router.query.id))}
        >
