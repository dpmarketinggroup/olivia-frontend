...
const Floor6Extension = () => {
  const fetch = useStore((state) => state.setSelectedApartment);
  const router = useRouter();
  const [thirteen] = useAvailability("07.13");
  const [twelve] = useAvailability("07.12");
  const [eleven] = useAvailability("07.11");
  const [ten] = useAvailability("07.10");
  const [nine] = useAvailability("07.09");
  const [eight] = useAvailability("07.08");
  const [seven] = useAvailability("07.07");
  const [six] = useAvailability("07.06");
  const [five] = useAvailability("07.05");
  const [four] = useAvailability("07.04");
  const [three] = useAvailability("07.03");
  const [two] = useAvailability("07.02");
  const [one] = useAvailability("07.01");
  const [K_eight] = useAvailability("K708");
  const [K_seven] = useAvailability("K707");
  const [K_six] = useAvailability("K706");
  const [K_five] = useAvailability("K705");
  const [K_four] = useAvailability("K704");
  const [K_three] = useAvailability("K703");
  const [K_two] = useAvailability("K702");
  const [K_one] = useAvailability("K701");
  return (
    <>
      <g id="_x30_7.13">
        <g
          ...
          onClick={() => fetch("07.13", Number(router.query.id))}
        >
      ...
      <g id="_x30_7.12">
        <g
          ...
          onClick={() => fetch("07.12", Number(router.query.id))}
        >
      ...
      <g id="_x30_7.11">
        <g
          ...
          onClick={() => fetch("07.11", Number(router.query.id))}
        >
      ...
      <g id="_x30_7.10">
        <g
          ...
          onClick={() => fetch("07.10", Number(router.query.id))}
        >
      ...
      <g id="_x30_7.09">
        <g
          ...
          onClick={() => fetch("07.09", Number(router.query.id))}
        >
      ...
      <g id="_x30_7.08">
        <g
          ...
          onClick={() => fetch("07.08", Number(router.query.id))}
        >
      ...
      <g id="_x30_7.07">
        <g
          ...
          onClick={() => fetch("07.07", Number(router.query.id))}
        >
      ...
      <g id="_x30_7.06">
        <g
          ...
          onClick={() => fetch("07.06", Number(router.query.id))}
        >
      ...
      <g id="_x30_7.05">
        <g
          ...
          onClick={() => fetch("07.05", Number(router.query.id))}
        >
      ...
      <g id="_x30_7.04">
        <g
          ...
          onClick={() => fetch("07.04", Number(router.query.id))}
        >
      ...
      <g id="_x30_7.03">
        <g
          ...
          onClick={() => fetch("07.03", Number(router.query.id))}
        >
      ...
      <g id="_x30_7.02">
        <g
          ...
          onClick={() => fetch("07.02", Number(router.query.id))}
        >
      ...
      <g id="_x30_7.01">
        <g
          ...
          onClick={() => fetch("07.01", Number(router.query.id))}
        >
      ...
      <g id="_x30_K701">
        <g
          ...
          onClick={() => fetch("K701", Number(router.query.id))}
        >
      ...
      <g id="_x30_K702">
        <g
          ...
          onClick={() => fetch("K702", Number(router.query.id))}
        >
      ...
      <g id="_x30_K703">
        <g
          ...
          onClick={() => fetch("K703", Number(router.query.id))}
        >
      ...
      <g id="_x30_K704">
        <g
          ...
          onClick={() => fetch("K704", Number(router.query.id))}
        >
      ...
      <g id="_x30_K705">
        <g
          ...
          onClick={() => fetch("K705", Number(router.query.id))}
        >
...
export default Floor6Extension;
