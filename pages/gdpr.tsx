    ...
    return (
        <>
            ...
            <div className="flex justify-center">
                <div className="mx-4 xl:mx-[450px] mb-[210px] w-full xl:max-w-[1200px]">
                    ...
                    <div className={'py-[15px]'}>
                        <div className={'flex justify-between'}>
                            ...
                            <span className={'w-full max-w-[500px] ml-auto '}>EURO INVEST spol. s r.o.</span>
                        </div>
                        <div className={'flex justify-between'}>
                            <h4 className={'font-bold'}>Adresa prevádzkovateľa:</h4>
                            <span className={'w-full max-w-[500px] ml-auto '}>Tomášikova 50/E 831 04 Bratislava</span>
                        </div>
                        <div className={'flex justify-between'}>
                            <h4 className={'font-bold'}>IČO prevádzkovateľa:</h4>
                            <span className={'w-full max-w-[500px] ml-auto '}>31359426</span>
                        </div>
                    </div>
                    <hr className={'border'}/>
                    <div className={'flex flex-col gap-[25px] mt-[15px]'}>
                        <div className={'flex justify-between'}>
                            ...
                            <span className={'w-full max-w-[500px] ml-auto '}>meno a priezvisko, e-mailová adresa a/alebo telefónne číslo</span>
                        </div>
                        <div className={'flex justify-between'}>
                            <h4 className={'font-bold'}>Osobitné kategórie spracúvaných osobných údajov:</h4>
                            <span className={'w-full max-w-[500px] ml-auto'}>osobitná kategória osobných údaj sa nespracúva</span>
                        </div>
                        <div className={'flex justify-between'}>
                            <h4 className={'font-bold'}>Účel spracúvania:</h4>
                            <span className={'w-full max-w-[500px] ml-auto'}>zasielanie marketingových správ</span>
                        </div>
                        <div className={'flex justify-between'}>
                            <h4 className={'font-bold'}>Kategórie dotknutých osôb:</h4>
                            <span className={'w-full max-w-[500px] ml-auto'}>fyzické osoby, ktoré vyplnili dotazník na webovej stránke: www.oliviaresidence.sk</span>
                        </div>
                        <div className={'flex justify-between'}>
                            <h4 className={'font-bold'}>Právny základ spracúvania:</h4>
                            <span className={'w-full max-w-[500px] ml-auto'}>čl. 6 ods. 1 písm. a) všeobecného nariadenia o ochrane údajov – súhlas dotknutej osoby</span>
                        </div>
                        <div className={'flex justify-between'}>
                            <h4 className={'font-bold'}>Doba spracovania:</h4>
                            <span className={'w-full max-w-[500px] ml-auto'}>3 roky</span>
                        </div>
                        <div className={'flex justify-between'}>
                            <h4 className={'font-bold'}>Poskytovanie osobných
                                údajov tretím stranám:</h4>
                            <span className={'w-full max-w-[500px] ml-auto'}>zákonom oprávnené subjekty
	dpMarketingGroup, s. r. o., Námestie sv. Egídia 55, 058 01 Poprad, IČO:52526071
</span>
                        </div>
                        <div className={'flex justify-between'}>
                            ...
                            <span className={'w-full max-w-[500px] ml-auto'}>neuskutočňuje sa</span>
                        </div>
                        <div className={'flex justify-between'}>
                            <h4 className={'font-bold'}>Práva dotknutej osoby:</h4>
                            <span className={'w-full max-w-[500px] ml-auto'}>
