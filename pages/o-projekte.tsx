...
const OProjekte = () => {
  ...
  return (
    <>
      ...
      <div className="w-full mx-auto mt-[12rem] sm:mt-[15rem] mb-20 max-w-[1200px] ">
        <div className="bg-bgLight  flex flex-row relative justify-between items-end">
          ...
          <div className="w-full md:w-[45%] flex flex-col gap-8 ml-4 px-4 pt-40 md:pt-2 md:ml-10 my-4 md:my-10">
            <h2 className="text-black text-center md:text-left text-[35px] md:text-[48px] leading-none">{translate("description-lokalita-5-heading-1")}<span className="text-primary" >{translate("description-lokalita-5-heading-2")}</span>{translate("description-lokalita-5-heading-3")}</h2>
            <p className="text-black text-center md:text-left text-[22px] md:text-[24px] leading-[32px] mb-12 ">{translate("description-lokalita-5-description")}</p>
            <Link href="/stretnutie">
              <button
      ...
      <div className="max-w-[1200px] mt-20 mb-[2rem] xs:mb-[2rem] sm:mb-[4rem] h-fit md:my-20 w-full mx-auto ">
            ...
            <div className="bg-yellow max-w-[1200px] relative p-6 md:p-8 mx-4 lg:mx-auto">
              ...
              <div className="flex flex-col md:flex-row justify-between items-center">
                <div className="w-full md:w-2/3">
                  <h3 className="text-[36px] text-center md:text-left md:text-[42px] text-[#0E3F3B] leading-none mb-8  md:w-[70%] z-[20] relative">{translate("financial-helper")}</h3>
                  <p className="text-[18px] text-center md:text-left text-[#0E3F3B] z-[20] relative md:w-full ">{translate("financial-helper-text")}</p>
                </div>
                <Link href="/kontakt">
                  <button
                    className={
